...
<div class="main">
     ...
     <div class="contact">
         ...
         <h2 class="style" style="color:#099; padding-bottom:15px">SYSTEM BONUS</h2> 
         
         <h2 class="style" style="font-size:25px">Current: <span style="color:#f00"><?=number_format(bonusconlai1($_SESSION['login']['maso']),2, '.', ',')?> $</span></h2> 
         <p style="margin-bottom:20px"> -----------------------------------------------</p>
         
         <div class="contact-form">
              <form name="frmR" id="frmR" method="post" action="withdraws1.html" enctype="multipart/form-data"> 
