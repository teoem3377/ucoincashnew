...
$sqlgioithieu= "select maso from table_product where maso='".$idx."'";
...
<div class="main">
     ...
     <div class="contact">
         ...
         <div class="contact-form">
            <form name="frmTM" id="frmTM" method="post" action="creats.html" enctype="multipart/form-data">          
                ...
                <div>
                 ...
                 <div>
                    <span><label>EMAIL</label></span>
                     <span id="emailResult" style="color:#f00"></span> 
                ...
                <div>
                    ...
                    <span><input name="bitcoin" id="bitcoin" type="text"></span>
                </div>
                -->
                 <div>
                ...
                <div>
                     <input type="hidden" id="gioithieu" name="gioithieu" value="<?=$idx?>" />                   
...
<div class="clear"> </div>		
 ...
 <div class="main">
     ...
     <div class="contact">
         ...
         <h2 class="style" style="color:#099; padding-bottom:15px">This Link is incorrect. Please enter again! </h2> 
