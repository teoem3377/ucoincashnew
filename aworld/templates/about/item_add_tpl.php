<script type="text/javascript">
	tinyMCE.init({
		// General options
		mode : "exact",
        elements : "noidung_vi,noidung_en,noidung_ci,mota_vi,mota_en,mota_ci",
		theme : "advanced",
		convert_urls : false,
...
<form name="frm" method="post" action="index.php?com=about&act=save" enctype="multipart/form-data" class="nhaplieu">  
   <!-- <b>Tên:</b> <input type="text" name="ten_vi" value="<?=$item['ten_vi']?>" class="input" /><br /><br />
    ...
    <b>Mô tả</b>
	<div>
	 <textarea name="mota_vi" id="mota_vi"><?=$item['mota_vi']?></textarea></div><br />
    <b>Mô tả (English)</b>
	<div>
    <textarea name="mota_en" id="mota_en"><?=$item['mota_en']?></textarea></div><br />
    <b>Mô tả (China)</b>
	<div>
    <textarea name="mota_ci" id="mota_ci"><?=$item['mota_ci']?></textarea></div><br />-->
    <b>Nội dung giới thiệu</b>
	<div>
	 <textarea name="noidung_vi" id="noidung_vi"><?=$item['noidung_vi']?></textarea></div><br />
  <!-- 
  <b>Nội dung luật chơi</b>
	<div>
