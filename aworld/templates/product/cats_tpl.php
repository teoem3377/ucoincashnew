...
<h3><a href="index.php?com=product&act=add_cat">Thêm mức thưởng</a></h3>
<table class="blue_table">
	...
	<tr>
	    ...
	    <td align="center" style="width:20%;"><a href="index.php?com=product&act=edit_cat&id=<?=$items[$i]['id']?>" style="text-decoration: none;"><?=$items[$i]['ten_vi']?></a></td>		
		<td style="width:20%;"><?=$items[$i]['dinhmucnhanh']?></td>
        <td style="width:20%;"><?=$items[$i]['dinhmuctong']?></td>
        <td style="width:20%;"><?=number_format($items[$i]['phanthuong'],0, ',', '.')?> VNĐ</td>
        <td style="width:5%;">		
			<?php 
		...
		<td style="width:5%;"><a href="index.php?com=product&act=edit_cat&id=<?=$items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a></td>
