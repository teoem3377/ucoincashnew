...
<h3>Thêm mức thưởng F1</h3>

<form name="frm" method="post" action="index.php?com=product&act=save_cat4" enctype="multipart/form-data" class="nhaplieu">	    	    
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product&act=man_cat4'" class="btn" />
</form>