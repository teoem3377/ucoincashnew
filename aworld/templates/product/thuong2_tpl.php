...
function onSearch(evt) {
		...
		location.href = "index.php?com=product&act=thuong2&batdau="+batdau+"&ketthuc="+ketthuc+"&id_list="+id_list+"&keyword="+keyword;
...
function get_main_list()
	{
		$sql="select ten_vi,id from table_product_cat2  order by stt asc";
		$stmt=mysql_query($sql);
		$str='
			<select id="id_list" name="id_list" class="main_font">
			<option value="">Mức thưởng </option>			
			';
...
<h3>Quản lý thưởng pin</h3> 

<div style="float:left; margin-bottom:5px">
        <div style="float:left">
            <form name="frm" method="post" action="index.php?com=export5&act=save&curPage=<?=$_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
...
<table class="blue_table">
	<tr>
        ...
        <th style="width:10%;">Phần thưởng</th> 
        <th style="width:8%;">Ngày đạt</th>
