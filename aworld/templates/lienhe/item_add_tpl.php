...
<form name="frm" method="post" action="index.php?com=lienhe&act=save" enctype="multipart/form-data" class="nhaplieu">   
   <!-- <b>Bản đồ </b> <input type="text" name="map1" value="<?=$item['map1']?>" style="width:200px;"/><br /><br /> -->
   ...
   <b>Nội dung(Showrrom)</b><br/>
	<div>
	 <textarea name="noidung1_vi" id="noidung1_vi"><?=$item['noidung1_vi']?></textarea></div><br/>
     
      <b>Nội dung(Showrrom)(English)</b><br/>
	<div>
   
	 <textarea name="noidung1_en" id="noidung1_en"><?=$item['noidung1_en']?></textarea></div><br/>
