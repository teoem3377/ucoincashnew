...
if(isset($_GET['id'])){
	...
	$sql="select tenkhongdau,ten,id,id_list from #_product_cat where id='$id' limit 0,1 ";
	$d->query($sql);
	...
	$sql_tintuc = "select id,thumb,ten,tenkhongdau,gia,mota,photo,ngaytao from #_product where hienthi=1 and id_cat='".$loaitin[0]['id']."'";
